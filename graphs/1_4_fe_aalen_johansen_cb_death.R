...
dev_path <- paste0("./graphs/fe_aalen_johansen_cb_death_c5.png")
...
by(fe_st_data,
   ...
   function(x){
     ...
     if(i == 1){
       ...
       legend("topleft",
              legend = c("Comparators CB", "Comparators Survival",
                         "Cases CB", "Cases Survival"),
              col = rep(1:2, each = 2),
              lty = rep(1:2, 2),
              bty = "n")
     }
...
# Define output devices
dev_path <- paste0("./graphs/fe_aalen_johansen_cb_death_c7.png")
